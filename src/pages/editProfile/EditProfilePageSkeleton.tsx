    ...
    >
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-4 w-full max-w-[400px] px-2">
          ...
          <div className="w-full h-8 bg-gray-300 rounded-md animate-pulse animation-duration-1500" />
          ...
          <div className="flex flex-row">
            <div className="w-[33vw] h-10 bg-gray-300 rounded-md animate-pulse animation-duration-1500" />
            <div className="w-[33vw] h-10 bg-gray-300 rounded-md animate-pulse animation-duration-1500 mx-2" />
            <div className="w-[33vw] h-10 bg-gray-300 rounded-md animate-pulse animation-duration-1500" />
          </div>
          <div className="w-full h-8 bg-gray-300 rounded-md animate-pulse animation-duration-1500" />
        </div>
